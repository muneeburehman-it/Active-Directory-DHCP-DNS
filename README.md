**Project  — Active Directory, DHCP \& DNS Lab**
📌 Project Overview
===

This project demonstrates the deployment of a small Windows-based enterprise network using GNS3, Windows Server, Active Directory Domain Services (AD DS), DNS, and DHCP.
...
Example records were tested using:
...
Detailed documentation for this project is available in the following sections:
...
Project screenshots are stored in the:

screenshots/

directory.

They demonstrate the topology, server configuration, Active Directory, DNS, DHCP, domain joining, and verification steps.

📌 Project Status

Status: Completed and Verified

The complete lab was successfully deployed and tested in GNS3.
